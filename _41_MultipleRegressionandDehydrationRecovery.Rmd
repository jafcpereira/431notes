...
## Building My Favorite Scatterplot Matrices

My favorite way to augment scatterplot matrices adds loess smoothed lines in the upper panel, and correlations in the lower panel, with histograms down the diagonal. To do this, we first create two functions (these modifications come from Chang's R Graphics Cookbook), called `panel.hist` and `panel.cor`.

```{r panel.hist function}
...
## A Scatterplot Matrix for the `hydrate` data
...
## Summary Regression Output: Multiple Regression
