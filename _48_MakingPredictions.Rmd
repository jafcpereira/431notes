...
Let us, just for a moment, consider a "typical" island, exemplified by the median value of all the predictors\footnote{This approach is motivated by Faraway's 2nd Edition, pp. 52-53.}. There's a trick to creating this and dumping it in a vector I will call `x.medians`.
