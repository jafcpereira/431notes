...
```{r my scatterplot matrix, fig.height = 6}
...
```{r ggally scatterplot matrix, message = FALSE, fig.height = 6}
...
```{r plot residuals for ebmodel.1, fig.height = 6}
par(mfrow=c(2,2))
plot(ebmodel.1)
par(mfrow=c(1,1))
```
